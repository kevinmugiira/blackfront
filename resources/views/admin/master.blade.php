...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- //bootstrap-css -->
    <!-- Custom CSS -->
    <link href="{{asset('asset1/css/style.css')}}" rel='stylesheet' type='text/css' />
    <link href="{{asset('asset1/css/style-responsive.css')}}" rel="stylesheet"/>
    <!-- font CSS -->
    <link href='//fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>
    <!-- font-awesome icons -->
    <link rel="stylesheet" href="{{asset('asset1/css/font.css')}}" type="text/css"/>
    <link href="{{asset('asset1/css/font-awesome.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('asset1/css/morris.css')}}" type="text/css"/>
    <!-- calendar -->
    <link rel="stylesheet" href="{{asset('asset1/css/monthly.css')}}">
    <!-- //calendar -->
    <!-- //font-awesome icons -->
    <script src="{{asset('asset1/js/jquery2.0.3.min.js')}}"></script>
    <script src="{{asset('asset1/js/raphael-min.js')}}"></script>
    <script src="{{asset('asset1/js/morris.js')}}"></script>
</head>
<body>
...
{{--                                <div class="task-info clearfix">--}}
{{--                                    <div class="desc pull-left">--}}
{{--                                        <h5>ProductController Delivery</h5>--}}
...
{{--                        <li>--}}
{{--                            <a href="#">--}}
{{--                                <span class="photo"><img alt="avatar" src="{{asset('asset1/images/3.png')}}"></span>--}}
{{--                                <span class="subject">--}}
...
{{--                        <li>--}}
{{--                            <a href="#">--}}
{{--                                <span class="photo"><img alt="avatar" src="{{asset('asset1/images/1.png')}}"></span>--}}
{{--                                <span class="subject">--}}
...
{{--                        <li>--}}
{{--                            <a href="#">--}}
{{--                                <span class="photo"><img alt="avatar" src="{{asset('asset1/images/2.png')}}"></span>--}}
{{--                                <span class="subject">--}}
...
{{--                <li class="dropdown">--}}
{{--                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">--}}
{{--                        <img alt="" src="{{asset('asset1/images/2.png')}}">--}}
...
{{--                    <div class="panel-heading">--}}
                <div id="page-wrapper">
                    <div class="main-page">
                        <div class="tables">
{{--                            <h2 class="title1">Add Products:</h2>--}}

                            <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                                <div class="form-title">
{{--                                    <h4>Add ProductController :--}}
                                        ...
                                        <div class="row">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item " style="margin-right: 5px" role="presentation">
                                                    <button class="btn btn-info nav-link active" id="product-tab" data-toggle="tab" data-target="#product" type="button" role="tab" >Add Product</button>
                                                </li>
{{--                                                <li class="nav-item" style="margin-right: 5px" role="presentation">--}}
...
<script src="{{asset('asset1/js/bootstrap.js')}}"></script>
<script src="{{asset('asset1/js/jquery.dcjqaccordion.2.7.js')}}"></script>
<script src="{{asset('asset1/js/scripts.js')}}"></script>
<script src="{{asset('asset1/js/jquery.slimscroll.js')}}"></script>
<script src="{{asset('asset1/js/jquery.nicescroll.js')}}"></script>
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="{{asset('asset1/js/flot-chart/excanvas.min.js')}}"></script><![endif]-->
<script src="{{asset('asset1/js/jquery.scrollTo.js')}}"></script>
<!-- morris JavaScript -->
<script>
...
<!-- calendar -->
<script type="text/javascript" src="{{asset('asset1/js/monthly.js')}}"></script>
