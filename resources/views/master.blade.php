...
<div class="agileits_header">
    <div class="w3l_offers">
        <a href="{{asset('assets/products.html')}}">Today's special Offers !</a>
    </div>
                ...
                <div class="mega-dropdown-menu">
                    <div class="w3ls_vegetables">
                        <ul class="dropdown-menu drp-mnu">
                            ...
                            <li><a href="{{asset('assets/login.html')}}">Sign Up</a></li>
                        </ul>
                    </div>
                </div>
            </li>
    ...
    <div class="w3l_header_right1">
        <h2><a href="{{asset('assets/mail.html')}}">Contact Us</a></h2>
    </div>
...
<div class="logo_products">
    <div class="container">
        <div class="w3ls_logo_products_left">
            <h1><a href="{{asset('assets/index.html')}}"><span>Grocery</span> Store</a></h1>
        </div>
        <div class="w3ls_logo_products_left1">
            <ul class="special_items">
                <li><a href="{{asset('assets/events.html')}}">Events</a><i>/</i></li>
                <li><a href="{{asset('assets/about.html')}}">About Us</a><i>/</i></li>
                <li><a href="{{asset('assets/products.html')}}">Best Deals</a><i>/</i></li>
                <li><a href="{{asset('assets/services.html')}}">Services</a></li>
            </ul>
        </div>
        <div class="w3ls_logo_products_left1">
            <ul class="phone_email">
                <li><i class="fa fa-phone" aria-hidden="true"></i>0722 55 66 77</li>
                <li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:store@grocery.com">agrimarket@mail.com</a></li>
            </ul>
        </div>
        <div class="clearfix"> </div>
    </div>
    ...
    <div class="container">
        <div class="col-md-3 w3_footer_grid">
            ...
            <ul class="w3_footer_grid_list">
                ...
                <li><a href="{{asset('assets/products.html')}}">Best Deals</a></li>
                <li><a href="{{asset('assets/services.html')}}">Services</a></li>
                <li><a href="{{asset('assets/short-codes.html')}}">Short Codes</a></li>
            </ul>
        </div>
        <div class="col-md-3 w3_footer_grid">
            <h3>policy info</h3>
            <ul class="w3_footer_grid_list">
                <li><a href="{{asset('assets/faqs.html')}}">FAQ</a></li>
                <li><a href="{{asset('assets/privacy.html')}}">privacy policy</a></li>
                <li><a href="{{asset('assets/privacy.html')}}">terms of use</a></li>
            </ul>
        </div>
        <div class="col-md-3 w3_footer_grid">
